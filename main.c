...
//    struct NodeLinkedList node_list;
////    init_LinkedListbyNumber(&node_list, 4);
//    init_LinkedList(&node_list);
//    addNode(&node_list, 0);
//    addNode(&node_list, 1);
//    addNode(&node_list, 2);
//    addNode(&node_list, 3);
//
//    addEdge(&node_list, 1, 2, 6);
//    addEdge(&node_list, 1, 3, 2);
//    addEdge(&node_list, 1, 0, 5);
//    //addNode(&node_list, 1);
////    addEdge(&node_list, 1, 2, 6);
////    removeEdge(&node_list, 1, 2);
//    removeNode(&node_list, 2);
//    struct Node *curr = getNode(&node_list, 1);
//    //printf("%s\n",curr);
//    struct Edge* edge = curr->neighbors;
//    //printf("%f\n",edge[0].weight);
//    //printf("%f\n",edge->next->weight);
//    //printf("%s\n",edge);
//    //struct Node *curr1 = getNode(&node_list, 2);
//    //struct Edge* edge1 = curr1->neighborsIn;
//    while (edge!=NULL) {
//        printf("weight: %f\n",edge->weight);
//        edge = edge->next;
}